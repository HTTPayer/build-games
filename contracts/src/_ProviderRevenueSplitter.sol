...
/// @dev DEPRECATED — superseded by the RS-token-native version (vault removed, mutable treasury addresses). Kept for reference only.

import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/utils/ReentrancyGuard.sol";

interface IProviderRevenueShare_Old {
    /// @notice Credit any USDC already transferred to the contract since last distribution.
    function distribute() external;
}

/**
 * @title ProviderRevenueSplitter (DEPRECATED)
 ...
 */
contract ProviderRevenueSplitter_Deprecated is ReentrancyGuard {
    ...
    IProviderRevenueShare_Old public immutable revenueShare;
    ...
    constructor(
        ...
        IProviderRevenueShare_Old    _revenueShare,
