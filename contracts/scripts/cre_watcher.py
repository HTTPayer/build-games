...
Usage:
  ...
  uv run python cre_watcher.py --from-block 0          # force full re-scan
  uv run python cre_watcher.py --once                  # one sync pass, then exit
  uv run python cre_watcher.py --target staging-settings
"""
...
CHALLENGE_OPENED_SIG = "ChallengeOpened(uint256,bytes32,string,string,bytes32)"
